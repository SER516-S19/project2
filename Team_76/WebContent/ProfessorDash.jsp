...
<body>
			...
			<div style="float: center">
				<form action="LoginController" method="post">
					<input type="hidden" name="action" value="logoff"> <input
						class="logoutonly" type="submit" value="LogOut">
				</form>
			</div>
		</li>
	</ul>
		...
		<div>
			<div class="BTN">
				<input type="hidden" name="action" value="CreateQuiz"> <input
					style="margin-left: auto; margin-right: auto" type="submit"
					name="CreateQuiz" value="CreateQuiz">
			</div>
		</div>
	</form>
	...
	<form action="ProfessorController" method="post">
		<div>
			<div class="BTN">
				<input type="hidden" name="action" value="ViewGrades"> <input
					style="margin-left: auto; margin-right: auto" type="submit"
					name="ViewGrades" value="ViewGrades">
			</div>
		</div>
	</form>
	...
	<form action="ProfessorController" method="post">
		<div>
			<div class="BTN">
				<input type="hidden" name="action" value="Statistics"> <input
					style="margin-left: auto; margin-right: auto" type="submit"
