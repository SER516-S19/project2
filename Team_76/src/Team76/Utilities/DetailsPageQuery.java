...
public class DetailsPageQuery {
	...
	public void databaseConnect(String quiztitle, String qinstruct, String qtype, String shuffleAns, String clockType)
			throws Exception {
		...
		while (rs.next()) {
			...
			String query = "INSERT INTO quiz ( ProfId, QuizId, Status, DueDate,Timelimit, QuizTitle, Qinstruct, Quiztype, ShuffleAns, OptionSelected) VALUES ( 1 , "
					+ id + " , '', '2019-03-21', 0 ,' " + quiztitle + " '  , ' " + qinstruct + " ' , ' " + qtype
					+ " ' , ' " + shuffleAns + " ', ' " + clockType + " '  )";
