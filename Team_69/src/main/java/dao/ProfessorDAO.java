...
public class ProfessorDAO {
	...
	/**
	 * This method is used to retrieve all questions with provided quiz ID from
	 * Question Table.
	 */
	public List<Question> getAllQuestionFromQuizID(int quizID) {
		...
		try {
			...
			transaction = session.beginTransaction();
			Query query = session
					.createQuery("from  " + Question.class.getName() + " que where que.quiz.quizId = " + quizID);
			lists = query.list();
			transaction.commit();
		} catch (Exception sqlException) {
			if (transaction != null) {
	...
	/**
	 * This method is used to retrieve Quiz data with provided quiz ID from Quiz
	 * Table.
	 */
	...
	/**
	 * This method is used to retrieve all answers with provided question ID from
	 * Answer Table.
	 */
	public List<Answer> getAllAnswersFromQuestionID(int questionID) {
		...
		try {
			...
			Query query = session.createQuery(
					"from  " + Answer.class.getName() + " ans where ans.question.questionId = " + questionID);
			lists = query.list();
			transaction.commit();
		} catch (Exception sqlException) {
			if (transaction != null)
	...
	/**
	 * This method is used to retrieve Question data with provided question ID from
	 * Question Table.
	 */
