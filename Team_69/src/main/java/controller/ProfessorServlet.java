...
public class ProfessorServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("fetchQuizList".equalsIgnoreCase(flag)) {
			...
			getServletContext().getRequestDispatcher("/views/displayQuestionstoProfessor.jsp").forward(request,
					response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ("insertQuizDetails".equals(flag)) {
			...
			Quiz quiz = professorServices.insertQuizDetails(quizName, quizInstructions, quizType, isTimeLimitSet, hours,
					minutes, shuffle);
