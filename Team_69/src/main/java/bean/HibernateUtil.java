	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				/*
				 * 1.) uncomment line at 40 if you are running project for the first time it
				 * will create all database tables which are configured in this file 2.) Comment
				 * line at 40 if you have database tables already created. This line will drop
				 * all existing tables/data and create new tables with no records.
				 */
