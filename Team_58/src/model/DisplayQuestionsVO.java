...
/**
 * 
 * This class is created to display Questions to a student. It's a plain old
 * java object file.
 * 
 * @author Jainish Soni
...
public class DisplayQuestionsVO {
	...
	public DisplayQuestionsVO(int quizId, String question, List<String> correctAnswers, List<String> incorrectAnswers,
	...
	public DisplayQuestionsVO(int qId, int totalPoints, List<String> correctAnswers, List<String> incorrectAnswers,
			String question) {
