...
/**
 * Submit Quiz Servlet is a controller that Submits Quiz Submission of answers
 * after the selection of answers
 *
 * @author Sami
 * @version 1.0
 * @date 03/01/2019
...
public class SubmitQuizServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			...
			int displayQuestionsVOLength = Integer
					.parseInt(session.getAttribute("displayQuestionsVOLength").toString());
			...
			List<StudentResponseVO> studentResponseVOList = studentResponse
					.getStudentListFromCourseIdQuizIdUserId(courseId, quizId, userId);
