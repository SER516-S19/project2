...
div1.innerHTML = div1.innerHTML + "<input type='text' name='question' value='enter the question'size='30'+i><br> credits:<input type='text' name='points' value='enter the points'size=2><br>"
addAnswerFields();
}
