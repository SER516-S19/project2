...
INSERT INTO Quizzes (title, course_fk, instructions, shuffle,
	timeLimit, dateOpen, dateClose, graded, attempts, quizGroup, totalPoints)
VALUES ("Minute Quiz", 1, "This is a straightforward quiz. You have 1 minute.",
	1, 60, "2018-12-25", "2020-04-08", 1, 
	3, "Cool Questions", 340.5);
INSERT INTO Quizzes (title, course_fk, instructions, shuffle,
	timeLimit, dateOpen, dateClose, graded, attempts, quizGroup, totalPoints)
VALUES	("Nasty Quiz", 1,
	"This quiz will test how the system responds to 0s in certain areas", 0,
	0, "2018-12-25", "2020-04-08", 1, 0, "null" 90);
INSERT INTO Quizzes (title, course_fk, instructions, shuffle,
	timeLimit, dateOpen, dateClose, graded, attempts, quizGroup, totalPoints)
VALUES	("Surveillance Survey", 1,
	"This isn't for a grade, yet there are points.",
	1, 0, "2018-12-25", "2020-04-08", 0, 2, "likeability", 29);
INSERT INTO Quizzes (title, course_fk, instructions, shuffle,
	timeLimit, dateOpen, dateClose, graded, attempts, quizGroup, totalPoints)
VALUES	("Late Quiz", 1, "Dude, this was due a while ago.",
	1, 90000, "1995-12-25", "2012-10-31", 1, 5, "Being totally radical",
	9000000.9);
INSERT INTO Quizzes (title, course_fk, instructions, shuffle,
	timeLimit, dateOpen, dateClose, graded, attempts, quizGroup, totalPoints)
VALUES	(5 "Negatives", 1, "test negative numbers throughout", 0,
	-1, "2018-12-25", "2020-04-08", 1, -2, "negatives", -50);
...
INSERT INTO Choices (id, quiz_fk, content, isCorrect)
VALUES	(1, "Bears", 0);
INSERT INTO Choices (id, quiz_fk, content, isCorrect)
VALUES 	(1, "Bees", 1);
INSERT INTO Choices (id, quiz_fk, content, isCorrect)
...
VALUES 	(6, "Water", 1);
INSERT INTO Choices (id, quiz_fk, content, isCorrect)
VALUES 	(6, "A 5-star review of a cornfield on Yelp");
INSERT INTO Choices (id, quiz_fk, content, isCorrect)
VALUES 	(7, "Beats me.", 0);
INSERT INTO Choices (id, quiz_fk, content, isCorrect)
